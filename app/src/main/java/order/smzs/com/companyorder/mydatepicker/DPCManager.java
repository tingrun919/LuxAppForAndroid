package order.smzs.com.companyorder.mydatepicker;
...
public final class DPCManager {
    ...
    private void setDecor(List<String> date, HashMap<String, Set<String>> cache) {
        for (String str : date) {
            ...
            String res = key.substring(5,7);
            String resss = key.substring(0,5);
            int rsss = Integer.valueOf(res);

            key = resss +String.valueOf(rsss);
